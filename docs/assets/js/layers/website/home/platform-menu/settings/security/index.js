...
async function viewSessions() {
  ...
  try {
    ...
    alert('Failed to view active sessions');
  }
}
...
async function revokeAllSessions() {
  ...
  if (!confirm('This will sign you out of all devices, including this one')) {
    return;
  }
...
async function verifyVoiceIdentity() {
  ...
  try {
    ...
    alert('Failed to verify voice identity');
  }
}
...
async function runLivenessCheck() {
  ...
  try {
    ...
    alert('Failed to run liveness check');
  }
}
...
async function configureSecurityAlerts() {
  ...
  try {
    ...
    alert('Failed to configure security alerts');
  }
}
...
async function configureAccountLockout() {
  ...
  try {
    ...
    alert('Failed to configure account lockout');
  }
}
...
async function configureIPRestrictions() {
  ...
  try {
    ...
    alert('Failed to configure IP restrictions');
  }
}
