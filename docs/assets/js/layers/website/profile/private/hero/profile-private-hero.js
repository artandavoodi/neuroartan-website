...
const PROFILE_MODEL_TAB_SECTIONS = new Set(['model-foundation', 'model-training', 'model-personalization', 'model-sources', 'model-memory', 'model-voice', 'model-readiness', 'model-runtime', 'model-discovery']);
const PROFILE_MODEL_DASHBOARD_SECTIONS = new Set(['model-readiness']);
const PROFILE_MODEL_SETTINGS_SECTIONS = new Set(['model-settings', 'model-runtime']);
